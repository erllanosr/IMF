...
<body>
  <header>
    <nav class="topnav">
      ...
      <a href="../phpArchivos/modificar.php" class="active" target="_blank">Modificar</a>
      <a href="../phpArchivos/mostrar.php" target="_blank">Mostrar</a>
    </nav>
    <main>
      <h1>Modificar | CRUD</h1>
      <h3>Selecciona la persona que quieras modificar.</h3>
      <table class="tabla_Modificar">
        <tr>
          <th>id</th>
          <th>NOMBRE</th>
          <th>APELLIDO 1</th>
        ...
        ?>
            <tr>
              ...
              <th><a href="actualizar.php?id=<?php echo $row['id'] ?>">Modificar</a></th>
            </tr>
        <?php
          }
        }
