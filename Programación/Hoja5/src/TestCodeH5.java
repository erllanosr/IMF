...
public class TestCodeH5 {
	...
	public static void main(String[] args) {
		...
		for (i = 0; i < tabla.length;) {
			...
			x = (int) (Math.random() * (10 - 1) + 1);// Modifique esto para que me saliearan repetidos con un rango mas
														// pequeño , siempre evitando el 0
			...
			// sino ha entrado en el if habra encontrado un repetido y tendra que genera
			// otro numero aleatorio y no incremento para no perder esa posicion
